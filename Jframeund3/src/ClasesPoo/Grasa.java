...
public abstract class Grasa extends Alimento{
    ...
    public Grasa(double colesterol, String nombre, String nombreAlias,
        ...
        super(nombre, nombreAlias, "Grasas", cantidad, diasExpiracion, esPerecedero,
    ...
    public void aporteColesterol(){
        System.out.println("Este producto aporta: " + this.colesterol 
                + "mg de colesterol");
    }   
}
